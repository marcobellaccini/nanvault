...
describe Nanvault do
  ...
  describe Nanvault::Crypto do
    ...
    exp_cipher_key = Bytes[242, 148, 14, 232, 107, 148, 161, 161, 231, 163, 33, 126, 76, 248,
                           111, 156, 80, 25, 167, 128, 63, 196, 218, 59, 57, 127, 201, 253,
                           181, 244, 183, 59]
    
    exp_hmac_key = Bytes[87, 24, 4, 143, 42, 152, 187, 104, 86, 91, 63, 212, 89, 61, 132, 54,
                         14, 218, 203, 106, 210, 14, 14, 151, 1, 125, 248, 53, 191, 53, 199, 108]

    exp_cipher_iv = Bytes[251, 188, 216, 52, 195, 36, 99, 37, 67, 211, 168, 145, 210, 132, 3, 235]

    exp_ptext = Bytes[45, 45, 45, 10, 35, 32, 84, 101, 115, 116, 32, 102, 105, 108, 101, 10, 45,
